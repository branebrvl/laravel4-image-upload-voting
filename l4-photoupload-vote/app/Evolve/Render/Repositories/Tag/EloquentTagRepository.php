...
use Evolve\Render\Exceptions\TagNotFoundException;
...
class EloquentTagRepository extends AbstractRepository implements TagRepositoryInterface {
   ...
   *  
   * @param  mixed  $id      
   * @return \Evolve\Render\Models\Tag     
   */
   ...
   *
   * @return \Illuminate\Database\Eloquent\Collection|\Evolve\Render\Models\Tag[]
   * 
